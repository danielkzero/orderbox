<x-app-layout>
    <x-page-header title="Guia da API" description="Como liberar aplicativos, autenticar usuarios e consumir endpoints do OrderBox." />

    <div class="space-y-6">
        <x-panel>
            <div class="space-y-4 p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Base e seguranca</h2>
                <p class="text-sm text-gray-600 dark:text-gray-300">A API publica fica em <code>/api/v1</code>. O login exige duas camadas: cliente de API liberado e credenciais do usuario.</p>
...
Accept: application/json</pre>
        ...
        <x-panel>
            <div class="space-y-4 p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Login mobile</h2>
                <div class="rounded-xl bg-gray-950 p-4 text-sm text-gray-100">
  ...
  -d "password=sua_senha"</pre>
        ...
        <x-panel>
            <div class="space-y-4 p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Confirmacao 2FA</h2>
                <div class="rounded-xl bg-gray-950 p-4 text-sm text-gray-100">
  ...
  -d "code=123456"</pre>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">A sessao mobile anterior so e revogada depois que o codigo 2FA e validado.</p>
            </div>
        </x-panel>
  ...
  -H "Authorization: Bearer seu_access_token"</pre>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">O token Bearer identifica o usuario autenticado. Se outro login mobile acontecer com a mesma credencial, o token anterior perde validade.</p>
            </div>
        </x-panel>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100 text-sm dark:divide-gray-800">
                        <thead class="bg-gray-50 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:bg-gray-800/50">
                            <tr><th class="px-5 py-3">Status</th><th class="px-5 py-3">Codigo</th><th class="px-5 py-3">Quando ocorre</th></tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            <tr><td class="px-5 py-4">403</td><td class="px-5 py-4"><code>api_client_not_allowed</code></td><td class="px-5 py-4">Chave ausente, segredo invalido ou cliente bloqueado.</td></tr>
                            <tr><td class="px-5 py-4">422</td><td class="px-5 py-4"><code>validation_error</code></td><td class="px-5 py-4">Credencial, desafio ou codigo 2FA invalidos.</td></tr>
