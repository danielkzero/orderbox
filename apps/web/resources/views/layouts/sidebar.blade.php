@php
    $groups = [
        'MENU' => [
            ...
            ['route' => 'price-tables.index', 'label' => 'Tabelas de preco', 'icon' => 'tag'],
        ...
        'ADMINISTRACAO' => [
            ...
            ['route' => 'api-clients.index', 'label' => 'Liberacao API', 'icon' => 'key', 'roles' => ['Admin']],
            ['route' => 'security.index', 'label' => 'Seguranca e 2FA', 'icon' => 'lock'],
