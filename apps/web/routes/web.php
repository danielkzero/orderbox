...
Route::middleware(['auth', 'active.session', 'company.context'])->group(function () {
    ...
    Route::put('/orders/{order}/print-settings', [OrderActionController::class, 'updatePrintSettings'])->middleware('throttle:sensitive-write')->name('orders.print-settings.update');
