...
- o PDF permanece em A4 retrato;
- tabelas do PDF usam largura fixa, quebra de texto, tipografia compacta e
  largura interna automática para impedir corte lateral.
